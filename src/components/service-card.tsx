...
export function ServiceCard({ service }: ServiceProps) {
	return (
		<Card className="flex flex-col h-full overflow-hidden hover:shadow-lg transition-shadow duration-300">
			...
			<CardContent className={service.imageUrl ? "flex-grow pt-4" : "flex-grow"}>
				{service.imageUrl && <CardDescription className="line-clamp-2 mb-4">{service.description}</CardDescription>}
